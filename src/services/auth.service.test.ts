...
describe('signIn()', () => {
  it('should return a token', async () => {
    ...
    const signInResult = await authService.signIn(signInData.email, signInData.password, signInData.role)
  ...
  it('should throw an error if email is undefined', async () => {
    ...
    const doSignIn = () => authService.signIn(signInData.email, signInData.password, signInData.role)
  ...
  it('should throw an error if the user is not found', async () => {
    ...
    const soSignIn = () => authService.signIn(signInData.email, signInData.password, signInData.role)
